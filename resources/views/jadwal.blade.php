...
<head>
    ...
    <!--CSS ane-->
    <link rel="stylesheet" type="text/css" href="{!! asset('css/jadwalstyle.css') !!}">
...
<!--Jadwal-->
 ...
 <div class="section">
<div class="container">
<div class="course-content"><!--WARNING--><!-- BACA COMMENT PADA OLC.JS BAGIAN "COURSES PAGE DINAMIC CONTENT" SEBELUM MENGUBAH LINE BERIKUT -->
<div class="row course-info">
<div class="col-md-12">
<table class="table table-bordered table-hover ">
	<tbody>
		<tr class="info  wow fadeInLeftBig" data-wow-duration="2s">
			<th>Jam</th>
			<th>Kelas A</th>
			<th>Kelas B</th>
			<th>Kelas C</th>
